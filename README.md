...
**Цели:**
- Автоматический разбор неструктурированных и полуструктурированных текстов на естественном языке. 
- Импорт текстовых источников (DOCX/PDF/TXT/MD, вики-страницы, тексты из трекеров задач). 
- NLP/LLM-анализ: извлечение ролей, действий, событий, условий, артефактов, потоков данных. 
- Генерация диаграмм в целевых нотациях с авто-раскладкой и минимизацией пересечений. 
- Интерактивное редактирование, аннотирование, трассируемость элементов к исходным фрагментам. 
- Семантическая и синтаксическая валидация моделей; отчёты по качеству. 
- Экспорт/импорт (BPMN XML, XMI, SVG/PNG/PDF, DOCX-шаблоны).
